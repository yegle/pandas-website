...
Version 0.10 will follow within the next month with a `new file parser engine
<http://wesmckinney.com/blog/?p=543>`_ plus bug fixes. Work on 0.11 with
improved unicode support. dtype handling, and other infrastructural improvements
